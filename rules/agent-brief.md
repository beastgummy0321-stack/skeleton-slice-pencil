...
2. **`## Shared files touched` is a claim, not a fact.** A file the work needs that the ticket did
   not list is `blocked-upstream` — whether you would edit it or route around it.
